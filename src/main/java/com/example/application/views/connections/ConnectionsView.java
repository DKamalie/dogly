package com.example.application.views.connections;
...
@PermitAll
public class ConnectionsView extends HorizontalLayout {
    ...
    public ConnectionsView() {
        addClassNames("connections-view", Width.FULL, Display.FLEX, Flex.AUTO);
        setSpacing(false);
